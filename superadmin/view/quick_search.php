...
if (isset($_POST['seacrh'])) {
    ...
    $c_username = $_SESSION['superadmin_u_username'];
    ...
    if($data == null){
        echo '<div class="container h3">Sorry Data Not Found</div>';
        die();
    }
    ...
    foreach ($data as $row) {
        ...
        $this->obj->setCommentByCondition($c_username, $confirmation);
?>
        ...
        <div class="container text-center">
            <h5><span class="text-primary">Submit By</span> <?= $row['l_submitted_by'] ?> // <span class="text-primary">Submit Date</span> <?= date('d-m-Y h:i:s A', $row['l_add_on']) ?> <span class="float-right">Ticket ID- <span style="border: solid 1px;padding: 2px;"><?php echo $row['l_id']?></span> </span></h5>
        </div>
        <div class="container">
...
if (isset($_POST['commsubmit']) && $_POST['commsubmit'] == 'Submit') {
    ...
    $this->obj->saveComment($c_text, $c_username, $c_lead_id);
}
