    ...
    <div class="row mt-3"  >
        <div class="col-md-4">
            <div class="card mt-5" style="border: 3px solid #002244;">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="card-text"><span class="fa fa-user"></span>&nbsp;<?= $_SESSION['e_author_u_username'] ?></p>
                    <a href="index.php?controller=admin&function=editprofile" class="btn btn-primary" style="width: 90%; background-color: #002244; "><span class="fa fa-edit"></span>&nbsp; Profile</a>
                </div>
            </div>
            <div class="card mt-5" style="border: 3px solid #002244;">
        ...
        <div class="col-md-8">
            <div class="jumbotron text-center" style="width: 100%; height: 100%; border: 3px solid #002244;">
                <h6> <i class="fa fa-user-circle"></i> Welcome Author</h6>
