...
<form action="" method="post">
    <div class="row">
        ...
        <div class="col-sm-2">
            <input type="submit" value="Search" name="pin" class="btn btn-primary">
        </div>
    </div>
    ...
    <table id="example" class="container mb-5" style="width:100%" border="2">
        ...
        <tbody>
            ...
            foreach ($this->obj->showallData() as $row) {
                if ($date == date('Y-m-d', $row['l_add_on'])) {
                ...
                ?>
                    <tr style="background-color: <?=$color ?>;">
                        ...
                        <td><a href="javascript:void(0);" data-href="index.php?controller=author&function=getContent&id=<?= $row['l_confirmation_no'] ?>" class="openPopup"><i class="fas fa-tag text-danger"></i></a></td>
                        <td><?= $row['l_id'] ?></td>
                        ...
                        <td class="text-center">
                            <a href="index.php?controller=author&function=dataView&id=<?= $row['l_confirmation_no'] ?>" target="_blank">
