...
class authorModel
{
    ...
    {
        $r = "";
        $sql = "SELECT * FROM users WHERE u_role = 'author'";
        ...
        foreach ($result as $row) {
            ...
            if ($row['u_username'] == $email && $row['u_password'] == $password) {
                $_SESSION["e_author_u_id"] = $row['u_id'];
                $_SESSION["e_author_u_username"] = $row['u_username'];
                $_SESSION["e_author_u_role"] = $row['u_role'];
                $_SESSION['e_author_u_displayname'] = $row['u_displayname'];
                $_SESSION['e_author_u_nicename'] = $row['u_nicename'];
                $this->userAttendance();
    ...
    function userAttendance(){
        $username = $_SESSION['e_author_u_username'];
        $a_date = date('d-m-Y');
